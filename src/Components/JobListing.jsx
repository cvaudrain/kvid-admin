...
export default function JobListing(props){
    ...
    return(
        ...
        <button className="peach-gradient save-btn" onClick={props.edit}><i class="fas fa-2x fa-pencil-alt "></i></button>
        <button className="magenta-gradient save-btn" onClick={props.delete}><i class="fas fa-2x fa-trash-alt "></i></button>
        </div>
        </div>
        </div>
        </div>
